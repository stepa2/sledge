...
namespace Sledge.Rendering.Primitives
{
    ...
    public struct VertexStandard
    {
        ...
        /// <summary>The color of the vertex when untextured or in wireframe.</summary>
        public Vector4 Color;

        /// <summary>The texture coordinates of the vertex</summary>
        public Vector2 Texture;

        /// <summary>The color modifier of the vertex when solid, used for render modes and selection highlights</summary>
        public Vector4 Tint;
